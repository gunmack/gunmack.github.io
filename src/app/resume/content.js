  ...
  return (
    <div>
      ...
      <div>
        <pdf_text>
          <p>
            <strong>Languages:</strong> Python, C, HTML, CSS, Java, JavaScript,
            SQL
          </p>
          <p>
    ...
    <div>
      ...
      <pdf_div>
        <pdf_text>
          ...
          <ul>
            ...
            <li>
              👉 Implemented calculator functionalities like clearing inputs and
              deleting recent characters.
            </li>
          </ul>
        </pdf_text>
      </pdf_div>
      ...
      <pdf_div>
        <pdf_text>
          ...
          <ul>
            <li>
              👉 Utilized Numpy and Pygame libraries to develop a user-friendly
              interface that allows users to perform advanced image processing.
            </li>
            <li>
      ...
      <pdf_div>
        <pdf_text>
          ...
          <ul>
            ...
            <li>
              👉 Developed a dedicated page for the CSSS common rooms, embedding
              images, SVG maps along with clear and organized tables for various
      ...
      <div>
        <pdf_text>
          ...
          <ul>
            ...
            <li>
              👉 Utilized effective multitasking skills to seamlessly transition
              between front-end customer service and back-end kitchen operations
